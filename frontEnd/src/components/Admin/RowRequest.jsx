  ...
  return (
    <>
      <div
        ...
        className="grid grid-cols-[30px,1.5fr,1fr] sm:grid-cols-[30px,1.5fr,1fr,1fr,0.7fr]    gap-8"
      >
        ...
        <div className="border-b hidden border-[#eee] py-5 px-4 dark:border-strokedark sm:flex flex-row items-center">
          <p className="text-black dark:text-white">
            {formatDateRelativeToToday(date)}
          </p>
        </div>
        <div className="border-b hidden border-[#eee]  ir py-5 px-4 dark:border-strokedark sm:flex flex-row items-center">
