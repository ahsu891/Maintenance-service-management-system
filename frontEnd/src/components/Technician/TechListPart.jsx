...
function TechListPart({ allchecked, setAllChecked, list }) {
          ...
          <li key={data.technician_id}>
            <div className="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
              <input
                ...
                // checked={data.technician_id === localStorage.getItem("user_id")}
              ...
              >
                {data.technician_id === localStorage.getItem("user_id")
                  ? "Me"
